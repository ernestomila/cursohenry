...
function apilarCajas(arr) {
  ...
  return (suma > 50 ) ? "No se puede crear la pila" : stack;
}
console.log("Respuesta: ", apilarCajas([{nombre: "arroz", peso: 10},{nombre: "fideos", peso: 15},{nombre: "cafe", peso: 5},{nombre: "cafe", peso: 40}]));
