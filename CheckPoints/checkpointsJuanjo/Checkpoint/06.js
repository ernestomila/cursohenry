...
// agregar LOS NOMBRES de los productos en una góndola de supermercado en base a las comparaciones de sus precios,
...
console.log(tree.agregarProductos("Granos", productos));
